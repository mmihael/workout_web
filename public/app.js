...
/* WEBPACK VAR INJECTION */(function(Vue) {module.exports = Vue.component('exerciseForm', {
...
/* WEBPACK VAR INJECTION */(function(Vue) {module.exports = Vue.component('register', {
...
/* WEBPACK VAR INJECTION */(function(Vue) {module.exports = Vue.component('usersWorkoutList', {
...
/* WEBPACK VAR INJECTION */(function(Vue) {module.exports = Vue.component('usersWorkout', {
...
/* WEBPACK VAR INJECTION */(function(Vue) {module.exports = Vue.component('workoutForm', {
...
/* WEBPACK VAR INJECTION */(function(Vue) {module.exports = Vue.component('workoutList', {
...
/* WEBPACK VAR INJECTION */(function(Vue) {module.exports = Vue.component('workoutPick', {
...
module.exports = "<div class=\"container\">\r\n    <div class=\"row\">\r\n        <!--<div class=\"col-xs-12\">-->\r\n        <form v-on:submit.prevent=\"_submit\">\r\n            <div class=\"col-xs-12\">\r\n                <div class=\"from-group\">\r\n                    <div class=\"text-success\">{{ message }}</div>\r\n                    <div class=\"text-danger\">{{ errors.name }}</div>\r\n                    <label for=\"exercise.name\">Name</label>\r\n                    <input v-model=\"exercise.name\" class=\"form-control\" type=\"text\" id=\"exercise.name\" placeholder=\"Name\">\r\n                </div>\r\n            </div>\r\n            <div class=\"col-xs-12\">\r\n                <br>\r\n                <div class=\"from-group\">\r\n                    <label for=\"exercise.bodyWeight\">Weight type</label><br>\r\n                    <button id=\"exercise.bodyWeight\" class=\"btn btn-default\" v-on:click=\"exercise.bodyWeight = !exercise.bodyWeight\" type=\"button\">\r\n                        {{ exercise.bodyWeight ? 'Body weight' : 'Weights' }}\r\n                    </button>\r\n                </div>\r\n            </div>\r\n            <div class=\"col-xs-12\">\r\n                <div class=\"from-group text-right\">\r\n                    <button type=\"submit\" class=\"btn btn-default\">Create</button>\r\n                </div>\r\n            </div>\r\n        </form>\r\n        <!--</div>-->\r\n    </div>\r\n</div>"

/***/ }),
/* 13 */
/***/ (function(module, exports) {

module.exports = "<div class=\"container text-center\">\r\n    <div class=\"row\">\r\n        <div class=\"col-md-4 col-sm-6\">\r\n            <router-link to=\"/workout/pick\">\r\n                <button class=\"btn btn-default block-button\">\r\n                    <i class=\"fa fa-play-circle-o text-info\" aria-hidden=\"true\"></i> Pick workout\r\n                </button>\r\n            </router-link>\r\n        </div>\r\n        <div class=\"col-md-4 col-sm-6\">\r\n            <router-link to=\"/list/user/workouts\">\r\n                <button class=\"btn btn-default block-button\">\r\n                    <i class=\"fa fa-edit text-info\" aria-hidden=\"true\"></i> Edit workout statistics\r\n                </button>\r\n            </router-link>\r\n        </div>\r\n        <div class=\"col-md-4 col-sm-6\">\r\n            <router-link to=\"/list/workouts\">\r\n                <button class=\"btn btn-default block-button\">\r\n                    <i class=\"fa fa-list text-info\" aria-hidden=\"true\"></i> List workouts\r\n                </button>\r\n            </router-link>\r\n        </div>\r\n        <div class=\"clearfix\"></div>\r\n        <div class=\"col-md-4 col-sm-6\">\r\n            <router-link to=\"/create/workout\">\r\n                <button class=\"btn btn-default block-button\">\r\n                    <i class=\"fa fa-plus-circle text-success\" aria-hidden=\"true\"></i> Create workout\r\n                </button>\r\n            </router-link>\r\n        </div>\r\n        <div class=\"col-md-4 col-sm-6\">\r\n            <router-link to=\"/create/exercise\">\r\n                <button class=\"btn btn-default block-button\">\r\n                    <i class=\"fa fa-plus-circle text-success\" aria-hidden=\"true\"></i> Create exercise\r\n                </button>\r\n            </router-link>\r\n        </div>\r\n        <div class=\"col-md-4 col-sm-6\"></div>\r\n    </div>\r\n</div>"

/***/ }),
/* 14 */
/***/ (function(module, exports) {

module.exports = "<div class=\"container\">\r\n    <div class=\"row\">\r\n        <div class=\"col-md-4\"></div>\r\n        <div class=\"col-md-4\">\r\n            <form v-on:submit.prevent=\"_login\">\r\n                <div class=\"from-group\">\r\n                    <label for=\"username\">Username</label>\r\n                    <input v-model=\"username\" class=\"form-control\" type=\"text\" id=\"username\" placeholder=\"Username\">\r\n                </div>\r\n                <br>\r\n                <div class=\"from-group\">\r\n                    <label for=\"password\">Password</label>\r\n                    <input v-model=\"password\" class=\"form-control\" type=\"password\" id=\"password\" placeholder=\"Password\">\r\n                </div>\r\n                <br>\r\n                <div class=\"row text-center\">\r\n                    <button type=\"submit\" class=\"btn btn-default\">LogIn</button>\r\n                    <button type=\"button\" class=\"btn btn-default\" v-on:click.prevent=\"_goToRegister\">Register</button>\r\n                </div>\r\n            </form>\r\n        </div>\r\n        <div class=\"col-md-4\"></div>\r\n    </div>\r\n</div>"

/***/ }),
/* 15 */
/***/ (function(module, exports) {

module.exports = "<div class=\"container\">\r\n    <div class=\"row\">\r\n        <div class=\"col-md-4\"></div>\r\n        <div class=\"col-md-4\">\r\n            <form v-on:submit.prevent=\"_register\">\r\n                <div class=\"from-group\">\r\n                    <div class=\"text-info\">{{ message }}</div>\r\n                    <div class=\"text-danger\">{{ errors.username }}</div>\r\n                    <label for=\"register-username\">Username</label>\r\n                    <input v-model=\"req.username\" class=\"form-control\" type=\"text\" id=\"register-username\" placeholder=\"Username\">\r\n                </div>\r\n                <br>\r\n                <div class=\"from-group\">\r\n                    <div class=\"text-danger\">{{ errors.email }}</div>\r\n                    <label for=\"register-email\">Email</label>\r\n                    <input v-model=\"req.email\" class=\"form-control\" type=\"text\" id=\"register-email\" placeholder=\"Email\">\r\n                </div>\r\n                <br>\r\n                <div class=\"from-group\">\r\n                    <div class=\"text-danger\">{{ errors.password }}</div>\r\n                    <label for=\"register-password\">Password</label>\r\n                    <input v-model=\"req.password\" class=\"form-control\" type=\"password\" id=\"register-password\" placeholder=\"Password\">\r\n                </div>\r\n                <br>\r\n                <div class=\"from-group\">\r\n                    <label for=\"register-passwordr\">Repeat password</label>\r\n                    <input v-model=\"req.passwordRepeat\" class=\"form-control\" type=\"password\" id=\"register-passwordr\" placeholder=\"Repeat password\">\r\n                </div>\r\n                <br>\r\n                <div class=\"row text-center\">\r\n                    <button type=\"submit\" class=\"btn btn-default\">Register</button>\r\n                    <button type=\"button\" class=\"btn btn-default\" v-on:click.prevent=\"_goToLogin\">LogIn</button>\r\n                </div>\r\n            </form>\r\n        </div>\r\n        <div class=\"col-md-4\"></div>\r\n    </div>\r\n</div>\r\n"

/***/ }),
/* 16 */
/***/ (function(module, exports) {

module.exports = "<div class=\"container\">\r\n    <div class=\"row\">\r\n        <div class=\"col-xs-12\">\r\n            <div class=\"table-responsive\">\r\n                <table class=\"table table-bordered table-striped\">\r\n                    <thead>\r\n                        <tr>\r\n                            <th>ID</th>\r\n                            <th>Workout</th>\r\n                            <th>Created</th>\r\n                            <th></th>\r\n                        </tr>\r\n                    </thead>\r\n                    <tbody>\r\n                        <tr v-for=\"workout in usersWorkouts\">\r\n                            <td>#{{ workout.id }}</td>\r\n                            <td>{{ workout.workoutName }}</td>\r\n                            <td>{{ workout.createdAt }}</td>\r\n                            <td>\r\n                                <router-link v-bind:to=\"'/users/workout/' +  workout.id\">\r\n                                    <button class=\"btn btn-info\" type=\"button\">\r\n                                        <i class=\"fa fa-edit\" aria-hidden=\"true\"></i> Edit\r\n                                    </button>\r\n                                </router-link>\r\n                                <button class=\"btn btn-danger\" type=\"button\" v-on:click=\"_deleteUsersWorkout(workout.id)\">\r\n                                    <i class=\"fa fa-trash\" aria-hidden=\"true\"></i> Delete\r\n                                </button>\r\n                            </td>\r\n                        </tr>\r\n                    </tbody>\r\n                    <tfoot></tfoot>\r\n                </table>\r\n            </div>\r\n        </div>\r\n        <!--<div v-for=\"workout in usersWorkouts\" class=\"col-xs-12\">-->\r\n            <!--<router-link v-bind:to=\"'/users/workout/' +  workout.id\">-->\r\n                <!--#{{ workout.id }}-->\r\n                <!--{{ workout.workoutName }}-->\r\n                <!--{{ workout.createdAt }}-->\r\n            <!--</router-link>-->\r\n            <!--<button class=\"btn btn-danger\" type=\"button\" v-on:click=\"_deleteUsersWorkout(workout.id)\">Delete</button>-->\r\n            <!--<hr>-->\r\n        <!--</div>-->\r\n    </div>\r\n</div>"

/***/ }),
/* 17 */
/***/ (function(module, exports) {

module.exports = "<div class=\"container\" xmlns:v-on=\"http://www.w3.org/1999/xhtml\" xmlns:v-bind=\"http://www.w3.org/1999/xhtml\">\r\n    <div class=\"row\">\r\n        <div class=\"col-xs-12 text-right\">\r\n            <span class=\"text-success pull-left\">{{ usersWorkout.workout.name }}</span>\r\n            <button class=\"btn btn-primary\" type=\"button\" v-on:click=\"_stopWatchToggle()\">\r\n                <i style=\"font-size: 24px;\" class=\"fa fa-clock-o\" aria-hidden=\"true\"></i>\r\n            </button>\r\n            <hr>\r\n        </div>\r\n    </div>\r\n    <div class=\"row\" v-for=\"(exerciseOrder, id) in usersWorkout.workoutExerciseOrder\">\r\n        <div class=\"col-md-6 col-xs-12\">\r\n            #<span class=\"text-muted\">{{ id }}</span> {{ usersWorkout.exercises[exerciseOrder.exercise].name }}\r\n        </div>\r\n        <!--<div class=\"col-xs-6\">-->\r\n        <div class=\"form-inline\">\r\n            <div class=\"form-group col-md-3 col-xs-6\">\r\n                <label v-bind:for=\"'weight-' + usersWorkout.usersWorkoutStatistics[id].id\">Weight:</label>\r\n                <input\r\n                        v-bind:disabled=\"usersWorkout.exercises[exerciseOrder.exercise].bodyWeight\"\r\n                        class=\"form-control\"\r\n                        v-model=\"usersWorkout.usersWorkoutStatistics[id].weight\"\r\n                        type=\"number\"\r\n                        v-bind:id=\"'weight-' + usersWorkout.usersWorkoutStatistics[id].id\"\r\n                        v-on:change=\"_updateUsersWorkoutStatistic(usersWorkout.usersWorkoutStatistics[id])\"\r\n                >\r\n            </div>\r\n            <div class=\"form-group col-md-3 col-xs-6\">\r\n                <label v-bind:for=\"'reps-' + usersWorkout.usersWorkoutStatistics[id].id\">Reps:</label>\r\n                <input\r\n                        class=\"form-control\"\r\n                        v-model=\"usersWorkout.usersWorkoutStatistics[id].reps\"\r\n                        type=\"number\"\r\n                        v-bind:id=\"'reps-' + usersWorkout.usersWorkoutStatistics[id].id\"\r\n                        v-on:change=\"_updateUsersWorkoutStatistic(usersWorkout.usersWorkoutStatistics[id])\"\r\n                >\r\n            </div>\r\n        </div>\r\n        <!--</div>-->\r\n        <div class=\"col-xs-12\"><hr></div>\r\n    </div>\r\n    <div v-if=\"stopWatch.show\" class=\"custom-modal-container\" v-on:click.self=\"_stopWatchToggle()\">\r\n        <div class=\"modal-dialog modal-sm\" role=\"document\">\r\n            <div class=\"modal-content\">\r\n                <div class=\"modal-header\">\r\n                    <button v-on:click.stop=\"_stopWatchToggle()\" type=\"button\" class=\"close\"><span aria-hidden=\"true\">&times;</span></button>\r\n                    <h4 class=\"modal-title\">Stop Watch</h4>\r\n                </div>\r\n                <div class=\"modal-body\">\r\n                    <div class=\"row\">\r\n                        <div class=\"col-xs-12 text-center\">\r\n                            <br>\r\n                            <br>\r\n                            <h3>{{ stopWatch.elapsed | ms-to-sec }}</h3>\r\n                        </div>\r\n                        <div class=\"col-xs-12\">\r\n                            <div class=\"form-group\">\r\n                                <label for=\"stopWatch.seconds\">Seconds</label>\r\n                                <input v-model=\"stopWatch.total\" type=\"number\" class=\"form-control\" id=\"stopWatch.seconds\" placeholder=\"Seconds\">\r\n                            </div>\r\n                            <button style=\"width: 100%;\" class=\"btn btn-success\" v-on:click=\"_stopWatchStart()\">Start</button>\r\n                        </div>\r\n                    </div>\r\n                </div>\r\n                <div class=\"modal-footer\">\r\n                    <button v-on:click.stop=\"_stopWatchToggle()\" type=\"button\" class=\"btn btn-default\">Close</button>\r\n                </div>\r\n            </div>\r\n        </div>\r\n    </div>\r\n</div>"

/***/ }),
/* 18 */
/***/ (function(module, exports) {

module.exports = "<div class=\"container\" xmlns:v-on=\"http://www.w3.org/1999/xhtml\">\r\n    <div class=\"row\">\r\n        <div class=\"col-xs-12\">\r\n            <form v-on:submit.prevent=\"_submit\">\r\n                <div class=\"from-group\">\r\n                    <div class=\"text-success\">{{ message }}</div>\r\n                    <div class=\"text-danger\">{{ errors.name }}</div>\r\n                    <label for=\"workout.name\">Name</label>\r\n                    <input v-model=\"workout.name\" class=\"form-control\" type=\"text\" id=\"workout.name\" placeholder=\"Name\">\r\n                </div>\r\n                <br>\r\n                <div class=\"form-group\">\r\n                    <div class=\"row\">\r\n                        <div class=\"col-sm-6\">\r\n                            <div v-for=\"exercise in formOptions.exercises\" class=\"col-xs-12\" style=\"padding-bottom: 6px;\">\r\n                                <button type=\"button\" class=\"btn btn-default\" style=\"width: 100%;\"\r\n                                        v-on:click.prevent=\"_addExercise(exercise)\">\r\n                                    <i class=\"fa fa-plus-circle text-success pull-left\" aria-hidden=\"true\"></i> {{ exercise.name }}\r\n                                </button>\r\n                            </div>\r\n                        </div>\r\n                        <div class=\"col-sm-6\">\r\n                            <div class=\"col-xs-12\">\r\n                                <ul class=\"list-group\">\r\n                                    <li v-for=\"exercise in workout.workoutExerciseOrder\" class=\"list-group-item\">\r\n                                        #{{ exercise.order }} {{ exercise.name }} {{ exercise.id }}\r\n                                    </li>\r\n                                </ul>\r\n                            </div>\r\n                        </div>\r\n                    </div>\r\n                </div>\r\n                <br>\r\n                <div class=\"from-group text-right\">\r\n                    <button type=\"submit\" class=\"btn btn-default\">Create</button>\r\n                </div>\r\n            </form>\r\n        </div>\r\n    </div>\r\n</div>"

/***/ }),
/* 19 */
/***/ (function(module, exports) {

module.exports = "<div class=\"container\">\r\n    <div class=\"row\">\r\n        <div v-for=\"workout in workouts\" class=\"col-xs-12\">\r\n            {{ workout.workout.name }}\r\n            <br>\r\n            <ul>\r\n                <li class=\"text-success\" v-for=\"exercise in workout.exercises\"\r\n                >#{{ exercise.order }} {{ exercise.name }}</li>\r\n            </ul>\r\n        </div>\r\n    </div>\r\n</div>"

/***/ }),
/* 20 */
/***/ (function(module, exports) {

module.exports = "<div class=\"container\" xmlns:v-on=\"http://www.w3.org/1999/xhtml\">\r\n    <div class=\"row\">\r\n        <div v-for=\"workout in workouts\" class=\"col-xs-12 col-sm-6 col-md-4\">\r\n            <ul class=\"list-group\">\r\n                <button class=\"list-group-item list-group-item-success\" v-on:click.prevent=\"_startWorkout(workout.workout.id)\">\r\n                    {{ workout.workout.name }}\r\n                    <i class=\"fa fa-play pull-right\" aria-hidden=\"true\"></i>\r\n                </button>\r\n                <li class=\"list-group-item\" v-for=\"exercise in workout.exercises\">\r\n                    #{{ exercise.order }} {{ exercise.name }}\r\n                </li>\r\n            </ul>\r\n        </div>\r\n    </div>\r\n</div>"
...
var router = new VueRouter({
    ...
    routes: [
        { path: '/', component: __webpack_require__(3) },
        { path: '/register', component: __webpack_require__(4) },
        { path: '/home', component: __webpack_require__(2) },
        { path: '/create/workout', component: __webpack_require__(7) },
        { path: '/list/workouts', component: __webpack_require__(8) },
        { path: '/create/exercise', component: __webpack_require__(1) },
        { path: '/workout/pick', component: __webpack_require__(9) },
        { path: '/users/workout/:id', component: __webpack_require__(6) },
        { path: '/list/user/workouts', component: __webpack_require__(5) },
    ]
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0), __webpack_require__(10), __webpack_require__(11)))
